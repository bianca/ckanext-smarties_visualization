...
class Smarties_VisualizationPlugin(plugins.SingletonPlugin):
    ...
    def update_config(self, config_):
        ...
        toolkit.add_resource('fanstatic', 'smarties_visualization')
    '''
    This extension views a hard-coded visual summary of a resource.
    '''
    def info(self):
        return {'name': 'smarties_visualization',
    ...
    '''
class SmartiesView(smarties_visualizationPlugin):
